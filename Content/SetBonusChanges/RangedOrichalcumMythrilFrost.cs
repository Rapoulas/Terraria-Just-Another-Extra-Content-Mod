...
namespace RappleMod.Content.SetBonusChanges
{
    public class RangedOrichalcumMythrilFrost : GlobalItem
    {
        ...
        {
            player.setBonus = "Hitting an enemy affected by Frostbite or Frostburn with a projectile has a 25% chance to deal the damage dealt to that enemy up to 5 other nearby enemies\nIncreases the damage of frost debuffs by 50%";
