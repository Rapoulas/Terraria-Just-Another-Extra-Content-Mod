...
{
	public class BrimstoneBeamM : ModProjectile
	{
        ...
        public override void AI() {
			...
			if (Projectile.type != ModContent.ProjectileType<BrimstoneBeamM>() || !hostBeam.active || hostBeam.type != ModContent.ProjectileType<BrimstoneHoldOut>()) {
                Projectile.Kill();
				return;
			}
        ...
        public override bool PreDraw(ref Color lightColor) {
			...
			Texture2D brimstoneStartTexture = ModContent.Request<Texture2D>("RappleMod/Content/Projectiles/Brimstone/BrimstoneBeamMstart", AssetRequestMode.ImmediateLoad).Value;
            Texture2D brimstoneBodyTexture = ModContent.Request<Texture2D>("RappleMod/Content/Projectiles/Brimstone/BrimstoneBeamMmid", AssetRequestMode.ImmediateLoad).Value;
            Texture2D brimstoneEndTexture = ModContent.Request<Texture2D>("RappleMod/Content/Projectiles/Brimstone/BrimstoneBeamMend", AssetRequestMode.ImmediateLoad).Value;
		...
		public static void DrawBeamStart(SpriteBatch sb, Texture2D tex, Vector2 start, Vector2 end, Vector2 scale, Color beamColor, LaserLineFraming framing, int timer){
			...
			Rectangle brimstoneStartRectangle = new Rectangle(0, 30 * (timer / 7 % 4), brimstoneStartTexture.Width, 28);
