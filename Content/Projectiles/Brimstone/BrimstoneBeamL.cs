...
namespace RappleMod.Content.Projectiles.Brimstone
{
	public class BrimstoneBeamL : ModProjectile
	{
        ...
        public override void AI() {
			...
			if (Projectile.type != ModContent.ProjectileType<BrimstoneBeamL>() || !hostBeam.active || hostBeam.type != ModContent.ProjectileType<BrimstoneHoldOut>()) {
                Projectile.Kill();
				return;
			}
			
            float chargeRatio = MathHelper.Clamp(((float)timer-50)/60, 0f, 1f);
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            Texture2D brimstoneBodyTexture = ModContent.Request<Texture2D>("RappleMod/Content/Projectiles/Brimstone/BrimstoneBeamLmid", AssetRequestMode.ImmediateLoad).Value;
            Texture2D brimstoneEndTexture = ModContent.Request<Texture2D>("RappleMod/Content/Projectiles/Brimstone/BrimstoneBeamLend", AssetRequestMode.ImmediateLoad).Value;
